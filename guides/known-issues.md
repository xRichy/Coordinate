...
- [ ] [Discovered during T1.1] Lint error pre-esistente in `apps/web/src/store/useAppStore.ts:6` — empty interface declaration (`@typescript-eslint/no-empty-object-type`). Da fixare in un task chore dedicato.
